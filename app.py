...
def home_page(pokemon_id=1):
    ...
    return render_template("home.html", pokemons=pokemons, selected_pokemon=selected_pokemon)
...
def capture_action(pokemon_id):
    pokemon_name = request.form['pokemon_name'] #pokemon given name??
    current_user.catch_pokemon(pokemon_id, pokemon_name)
